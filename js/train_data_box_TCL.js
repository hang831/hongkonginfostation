    ...
    $(document).ready(function() {
        ...
        const change = document.getElementById("accordionExample3");
        const change2 = document.getElementById("accordionExample4");
    ...
    if (select.value == "TCL"){ 
        ...
        document.querySelector(".TCL_UP").style.display="block";
        ...
        fetch(`https://rt.data.gov.hk/v1/transport/mtr/getSchedule.php?line=TCL&sta=${first3}&lang=tc`)
        .then(res => res.json())
        .then(res =>{
        //console.log(res);
        var station="TCL-"+first3 
        //console.log(station);
        arr=[];    
            ...
            for(i=0;i<7;i++){ //8station
            var contentname= ".TCLcontent"+[i];
        ...
        //console.log( document.getElementById("select").value, typeof "AEL");
            //console.log(select.value);
             if(select.value == "TCL2"){
                ...
                document.querySelector(".TCL_DOWN").style.display="block";
                document.querySelector(".TML_UP").style.display="none";
                document.querySelector(".TML_DOWN").style.display="none";
                document.querySelector(".TKL_UP").style.display="none";
                document.querySelector(".TKL_DOWN").style.display="none";
                ...
                fetch(`https://rt.data.gov.hk/v1/transport/mtr/getSchedule.php?line=TCL&sta=${first3_2}&lang=tc`)
                .then(res2 => res2.json())
                .then(res2 =>{
                //console.log(res2);
               //console.log(res2.data["AEL-AWE"]["DOWN"][1]);
               
                var station2="TCL-"+first3_2  
                ...
                arr2=[];
                    ...
                    for(i=0;i<7;i++){ //8record in this line
                        var contentname2= ".TCL2content"+[i];
            ...
            if (select.value != "TCL" && select.value != "TCL2" ){                    
           ...
           if ( (select.value == "TCL" || select.value == "TCL2")&&(count==1) ){ 
            line_item=null;
